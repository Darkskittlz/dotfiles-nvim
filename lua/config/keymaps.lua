...
-- keymap.set("n", ";r", "<cmd>Telescope live_grep<cr>", { desc = "Live grep" })
-- keymap.set("n", ";e", "<cmd>Telescope file_browser<cr>", { desc = "File browser" }) -- Or your preferred explorer
-- keymap.set("n", ";g", "<cmd>Telescope git_status<cr>", { desc = "Git status" })
-- keymap.set("n", ";;", "<cmd>Telescope resume<cr>", { desc = "Resume last search" })
