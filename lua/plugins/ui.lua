         ...
         config = function()
            local osakaConfig = {
               ...
               on_highlights = function(hl, c)
                  ...
                  -- Replaced util.darken with a direct hex value or theme color (e.g., c.green)
                  local keyword_color = '#00cc00'
                  ...
                  local tag_color = c.blue

                  -- JSX/TSX Standard Elements
                  hl['@tag.builtin'] = { fg = tag_color }
                  hl['@tag.delimiter'] = { fg = c.blue700 }
                  hl['@tag.attribute'] = { fg = '#6c71c4' }

                  -- Specific overrides for javascriptreact
